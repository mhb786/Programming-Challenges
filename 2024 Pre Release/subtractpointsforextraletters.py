...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        self.DisplayPuzzle()
        print()
        print(self.RemoveExtra(Patterns))
        return self.__Score
    ...
    def RemoveExtra(self, Patterns):
        ...
        for Cell in self.__Grid:
            if Cell._Symbol == 'Q':
                ...
                XNum += 1
        print(QNum, TNum, XNum)

        MinusScore += (QNum - Patterns['Q']*5)
        MinusScore += (XNum - Patterns['X']*5)
        print('x', MinusScore)
        MinusScore += (TNum - Patterns['T']*5)
        return MinusScore
