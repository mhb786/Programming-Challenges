                ...
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        if P.MatchesPattern(PatternString, CurrentSymbol):
                            ...
                            print("bad")
                            self.__GetCell(StartRow, StartColumn).DeleteFromNotAllowedSymbols(CurrentSymbol)
                            self.__GetCell(StartRow, StartColumn + 1).DeleteFromNotAllowedSymbols(CurrentSymbol)
                            self.__GetCell(StartRow, StartColumn + 2).DeleteFromNotAllowedSymbols(CurrentSymbol)
                            self.__GetCell(StartRow - 1, StartColumn + 2).DeleteFromNotAllowedSymbols(CurrentSymbol)
                            self.__GetCell(StartRow - 2, StartColumn + 2).DeleteFromNotAllowedSymbols(CurrentSymbol)
                            self.__GetCell(StartRow - 2, StartColumn + 1).DeleteFromNotAllowedSymbols(CurrentSymbol)
                            self.__GetCell(StartRow - 2, StartColumn).DeleteFromNotAllowedSymbols(CurrentSymbol)
                            self.__GetCell(StartRow - 1, StartColumn).DeleteFromNotAllowedSymbols(CurrentSymbol)
                            self.__GetCell(StartRow - 1, StartColumn + 1).DeleteFromNotAllowedSymbols(CurrentSymbol)
                except:
                    pass
        return 0
...
class Cell():
    ...
    def DeleteFromNotAllowedSymbols(self, SymbolToDelete):
        print("hi")
        self.__SymbolsNotAllowed.remove(SymbolToDelete)
